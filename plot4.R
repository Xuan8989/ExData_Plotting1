...
par(mfrow=c(2,2))
with(newdata, plot(combinedtime, Global_active_power, type="l", xlab="", ylab="Global Active Power"))
with(newdata, plot(combinedtime, Voltage, type = "l", xlab="datetime", ylab="Voltage"))
...
with(newdata, plot(combinedtime, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
dev.off()
